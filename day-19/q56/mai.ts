...
const mixedItemArray:(string | number |boolean)[]= ["Hira", 34, true, "Khalid", false, 123, "Rose"];

// Filter out only the strings from the mixed array with filter method:
const stringItemArray: string[] = mixedItemArray.filter((item)=> typeof item === "string");
