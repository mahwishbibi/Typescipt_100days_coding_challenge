...
//Think of something you could store in empty array:

let greatNation: string[] = [];

greatNation.push("IsamicRepublic Pakistan"); 
greatNation.push("Islamabad"); 
greatNation.push("Urdu");
greatNation.push("Indus River"); 

console.log(greatNation);
